...
const Register = () => {
    ...
    return (
        <div className={`min-h-screen w-full flex flex-col items-center p-6 pt-28 pb-12 relative overflow-hidden transition-all duration-700 ${
            isDark 
                ? "bg-[#09090b]" 
            ...
            <div className="w-full max-w-md z-10 my-auto">
                ...
                {/* Floating Card */}
                <div className={`p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] ${
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 dark:bg-violet-400/10 border border-indigo-500/20 dark:border-violet-400/20 mb-4">
                            <span className="text-[10px] tracking-[0.25em] uppercase font-bold text-indigo-600 dark:text-violet-300">
                                ✦ New Passport Account
                            </span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-2 text-zinc-950 dark:text-white leading-none">
                            Create Account
                        </h1>
                        <p className={`text-sm font-medium ${isDark ? "text-zinc-400" : "text-zinc-500"}`}>
                            Evolve your digital scrapbook with co-pilots
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-5 py-3 rounded-2xl text-sm outline-none bg-zinc-50/50 dark:bg-zinc-900/40 text-zinc-900 dark:text-white premium-input"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-3 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all cursor-pointer flex items-center justify-center gap-3 active:scale-98 select-none mt-2 ${
                                isDark 
                    ...
                    {/* Footer Links */}
                    <div className="mt-8 pt-6 border-t border-zinc-200/50 dark:border-zinc-800/40 text-center">
