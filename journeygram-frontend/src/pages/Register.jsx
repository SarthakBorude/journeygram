                ...
                <div className={`p-6 sm:p-10 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] ${
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-4 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all cursor-pointer flex items-center justify-center gap-3 active:scale-98 select-none mt-4 ${
                                isDark 
